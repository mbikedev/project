...
// business hours
      ...
      reservations: {
        ...
        success: 'Reservation submitted successfully! We will confirm your booking shortly.',
  ...
  fr: {
    translation: {
      ...
      reservations: {
        ...
        success: 'Réservation soumise avec succès ! Nous confirmerons votre réservation sous peu.',
        error: 'Échec de la soumission de la réservation. Veuillez réessayer.',
      },
      // Takeaway page
      takeaway: {
    ...
    translation: {
      ...
      reservations: {
        ...
        form: {
          ...
          submit: 'Tafel Reserveren',
        },
        success: 'Reservering succesvol ingediend! We zullen uw boeking binnenkort bevestigen.',
        error: 'Indiening van reservering mislukt. Probeer het opnieuw.',
      },
      // Takeaway page
      takeaway: {
